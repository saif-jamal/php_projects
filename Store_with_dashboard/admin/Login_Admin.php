...
$usercheck=$passcheck=0;
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if($usercheck==1 && $passcheck==1){
            $get_users=$connections->prepare("SELECT username as usnam,password as pass FROM users where role='admin';");
            $get_users->execute();
            ...
            foreach($users__ as $user__){
                if($user__['usnam']==$username && $user__['pass']==$password ){
                    ...
                    $message_error="Error! username or password is not correct <br> DC Admin to sent to you your login information";
                }
            }
        }
...
<style>
    <?php
    include "includes/assets/css/loginadmin.css";
    ?>
</style>
...
<body>
    ...
    <div class="container">
                    ...
                    <div class="col-lg-12 login-form">
                        <form method="post" action="<?php echo $_SERVER['PHP_SELF']?>" onsubmit="return validation()">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="admin_username" id="ad_username">
                            </div>
                            <div class="form-group">
                                <label class="form-control-label">PASSWORD</label>
                                <input type="password" class="form-control" name="admin_Password" id="ad_password">
                            </div>
        ...
        <script src="includes/assets/js/loginadmin.js"></script>
</body>
</html>