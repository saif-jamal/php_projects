...
$usercheck=$passcheck= $emailcheck=$imagecheck=0;
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if($usercheck==1 && $passcheck==1 && $emailcheck==1 && $imagecheck==1){
            ...
            $set_users=$connections->prepare("INSERT INTO users () VALUES('','{$username}','{$email}','{$password}','Active','admin','{$create_at}','','{$image}','');");
            $set_users->execute();
        ...
        <div class="container">
            <div class="signup-content">
                <form method="POST" action="<?php echo $_SERVER['PHP_SELF']?>" id="signup-form" class="signup-form" onsubmit="return validation()">
                    ...
                    <h2>Add Admin</h2>
                    <p class="desc">the admin will be add will have all  <span>“authentication and authorization” </span> in your dashboard.</p>
